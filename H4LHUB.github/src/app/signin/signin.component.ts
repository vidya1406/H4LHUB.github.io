        ...
        (result: any) => {
          ...
          if (
            ...
            if (result.data.role === 'PATIENT') {
              localStorage.setItem('patient-user-id', result.data.id);
              localStorage.setItem('patient-email', result.data.emailID);
              ...
              localStorage.setItem('doctor-user-id', result.data.id);
              localStorage.setItem('doctor-email', result.data.emailID);
              localStorage.setItem(
                'doctor-jwt-token',
                result.token.split('#')[0]
              );
            ...
            } else if (result.data.role === 'RECEPTIONIST') {
              localStorage.setItem('receptionist-user-id', result.data.id);
              localStorage.setItem('receptionist-email', result.data.emailID);
              localStorage.setItem(
                'receptionist-jwt-token',
                result.token.split('#')[0]
              );
              localStorage.setItem('receptionist-home', 'true');
              window.location.href = '/receptionistdashboard';
            } else if (result.data.role === 'PHARMACIST') {
              localStorage.setItem('pharmacist-user-id', result.data.id);
              localStorage.setItem('pharmacist-email', result.data.emailID);
              localStorage.setItem(
                'pharmacist-jwt-token',
                result.token.split('#')[0]
              );
